...
- **Problema:** Ambas as rotas realizam os seguintes passos:
  ...
  5.  Retornam a lista de `sessionQuestions`.
      Embora a lógica para _selecionar_ os cartões seja diferente, o processo subsequente de _transformá-los_ em questões é idêntico e poderia ser extraído para uma função compartilhada, evitando a repetição do `Promise.all` e da lógica de mapeamento.
      **Ferramenta:** Nenhuma
